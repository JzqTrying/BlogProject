        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="<%=base %>index.jsp"><i class="fa fa-diamond"></i> <span class="nav-label">首页</span></a>
                    </li>
                    ...
                    <div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="ibox-content m-b-sm border-bottom">
                            <div class="text-center p-lg">
                               <form class="m-t" role="form" action="<%=base %>admin/Category" method="post">
                <div class="form-group">
                    <input type="text" name="name" class="form-control" placeholder="分类名称" autocomplete="off"/>
                </div>
				<button type="submit" name="submit" class="btn btn-primary btn-sm">增加分类</button>              
...
<p style="color:red"><%=error==null?"":error %></p>             
                        ...
                        <div class="faq-item">
                            <div class="row">
                                <div class="col-md-7">
                                    <a data-toggle="collapse" href="#faq1" class="faq-question">${category.name}</a>
                                    <small> ${category.createDate}</small>
                                </div>
                                <div class="col-md-3">
                                    <span class="small font-bold">Robert Nowak</span>
                                    <div class="tag-list">
                                        <span class="tag-item"><a href="<%=base %>admin/CategoryEdit?id=${category.id}">编辑</a></span>
                                        <span class="tag-item"><a href="<%=base %>admin/CategoryDelete?id=${category.id}">删除</a></span>
                                    </div>
                                </div>
